...
| 2026.06.26   | 0.14.0          | [`0.14.0-rc1`](https://github.com/jovaynetwork/jovay-releases/releases/tag/v0.14.0-rc1) | jovay-release-registry.cn-hongkong.cr.aliyuncs.com/jovay/l2-rpc:0.14.0-rc1 | Introduces State Derivation and hardens RPC behavior for oversized `eth_call` input and interrupted WebSocket subscriptions. Standard RPC nodes only require an image upgrade. |
