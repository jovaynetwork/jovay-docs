...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-welcome.jpg" alt="welcome" style="max-width: 50%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-init.png" alt="init" style="max-width: 50%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-network-set.png" alt="init" style="max-width: 50%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-airdrop.png" alt="init" style="max-width: 70%;">
</div>

You can follow the link to verify that the transaction was successful.

<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-airdrop-tx-explorer.png" alt="init" style="max-width: 60%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-airdrop-tx-cli.png" alt="init" style="max-width: 60%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-dapp-init.png" alt="init" style="max-width: 60%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-dapp-build.png" alt="init" style="max-width: 80%;">
</div>
...
<div style="text-align: center;">
  <img src="../public/Images/jovay-cli/jovay-cli-dapp-deploy.png" alt="init" style="max-width: 80%;">
</div>
...
2. Call contract: \
   Now, run the following command to mint our nft!
    ...
    jovay contract write --contract 0x722526A8eB9e610B97736B2c50f40a0adE1a1368 \
                         --method safeMint --inputs address,string --args '"${RECEIVER_ADDRESS}","https://jovay-mainnet.oss-cn-hongkong.aliyuncs.com/jstack/jnft.json"' \
   ...
   If success, the transaction hash will be output, and also can be checked in the same way of [Get Funds](#step-2-get-funds).
    <div style="text-align: center;">
      <img src="../public/Images/jovay-cli/jovay-cli-dapp-call.png" alt="init" style="max-width: 80%;">
    </div>

   NFT can be explored at MetaMask after importing.

    <div style="text-align: center;">
      <img src="../public/Images/jovay-cli/nft-example.png" alt="init" style="max-width: 30%;">
    </div>
