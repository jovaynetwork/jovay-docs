...
```
https://jovay-mainnet.oss-cn-hongkong.aliyuncs.com/rwa/erc20/asset_operation/
```
...
**Full data snapshot:**
```
https://jovay-mainnet.oss-cn-hongkong.aliyuncs.com/rwa/erc20/asset_operation/date=2025-12-03/asset_operation_full.parquet
```

**Incremental data:**
```
https://jovay-mainnet.oss-cn-hongkong.aliyuncs.com/rwa/erc20/asset_operation/date=2025-12-04/asset_operation_increment.parquet
```
